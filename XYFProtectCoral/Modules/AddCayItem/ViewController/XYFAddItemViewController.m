...
- (void)performSave {
    ...
    //先判断选择品种;
    XYFCayTypeListModel* cayTypeListModel = [[XYFCayTypeListModel alloc] initWithTypeIndex:self.typeContentView.selectedType]; // 品种下标; 从 0 算起. 默认是 0
