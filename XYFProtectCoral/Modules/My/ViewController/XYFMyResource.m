...
- (void)setupView {
    ...
    self.nameTitleLabel.textColor = [UIColor jsd_mainTextColor];
    ...
    [self.savaButton setBackgroundColor:[UIColor jsd_mainTextColor]];
...
- (void)onTouchSave:(id)sender {
    ...
    if (havaTitle) {
        XYFMyCenterViewModel* viewmodel = [[XYFMyCenterViewModel alloc] init];
        ...
        if (self.havaPhoto) {
            ...
            [XYFPhotoManage savaImageView:self.imageView fileName: dateString];
        }
